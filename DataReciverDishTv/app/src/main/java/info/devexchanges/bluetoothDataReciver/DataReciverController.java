...
public class DataReciverController {
    ...
    public DataReciverController(Context context, Handler handler) {
    ...
    private void connectionFailed() {
        ...
        DataReciverController.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (state != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (DataReciverController.this) {
                        switch (state) {
                            case STATE_LISTEN:
